      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url() ?>assets/img/kabinet.png">
              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mt-5">
            <h1 class="h3 mb-0 text-gray-800" style="margin-left: 10%"><img width="100" src="<?php echo base_url() ?>assets/img/bem.png"> Selamat Datang Di Dashboard Admin Posko Kesma <img width="100" src="<?php echo base_url() ?>assets/img/kabinet.png"></h1>
          </div>
