    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">INFO USULAN MITRA</h1>
          <p class="mb-4">Menu usulan kos kesma adalah menu inputan untuk view info mitra yang berada pada halaman user .</p>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Tabel menu view info usulan mitra kesma</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php 
                      $no= 1;
                      foreach ($usulan ->result() as $mitra) { ?>
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><?php echo $mitra->nama; ?></td>
                      <td><?php echo substr($mitra->usulan,0,20);  ?>....<a href="" data-toggle="modal" data-target=".bd-example-modal-lg<?php echo $mitra->id_usulan ?>" title="Detail">More</a>
                      </td>
                      <td><a class="btn btn-danger" onclick="javascript: return confirm('Anda Yakin Akan Menghapus ?')" title="Hapus" href="<?php echo base_url('AdminPosko/Home/hapusUsulanMitra/'.$mitra->id_usulan) ?>" ><i class="fa fa-trash"></i></a></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
